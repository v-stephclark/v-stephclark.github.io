...
- The solution for this task is a YAML file in [the solutions folder]([../Solution/Exercise-02/Task-3/first-workflow.yml](https://github.com/microsoft/TechExcel-Implementing-DevOps-practices-to-accelerate-developer-productivity/blob/main/Coach/Solution/Exercise-02/Task-3/first-workflow.yml)).
